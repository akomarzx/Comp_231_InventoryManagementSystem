...
update `code_value`
set label = 'Fulfilled', updated_at = current_timestamp(), updated_by = 'rombao@my.centennialcollege.ca'
...
insert into code_value (code_value_id, code_book_id, label,created_at, created_by) values ('900030', 90000, 'Recevied',current_timestamp(), 'System');